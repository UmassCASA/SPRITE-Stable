...
def warp(input_tensor, flow, grid, mode="bilinear", padding_mode="zeros"):
    B, C, H, W = input_tensor.size()
    vgrid = grid + flow
    ...
    output = torch.nn.functional.grid_sample(
        input_tensor, vgrid, padding_mode=padding_mode, mode=mode, align_corners=True
    )
    return output
