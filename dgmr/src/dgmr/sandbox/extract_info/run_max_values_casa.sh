...
#SBATCH -o /work/pi_mzink_umass_edu/SPRITE/skillful_nowcasting/output/sbatch_logs/preprocessing_logs/max_casa-%j.out  # %j = job ID
...
python3 WORK/extract_info/max_values_casa.py
