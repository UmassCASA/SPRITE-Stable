...
def calculate_tensor_size_in_mib(tensor):
    """
    Calculate the size of a tensor in Mebibytes (MiB).

    Args:
        tensor (torch.Tensor): The tensor to calculate the size of.

    Returns:
        float: Size of the tensor in MiB.
    """
...
class ConvGRUCell(torch.nn.Module):
    ...
    def forward(self, x, prev_state):
        ...
        size_in_mib = calculate_tensor_size_in_mib(gated_input)
        # print("Size of gated_input in MiB:", size_in_mib)
