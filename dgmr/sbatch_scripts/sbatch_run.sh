...
#SBATCH -o /work/pi_mzink_umass_edu/SPRITE/skillful_nowcasting/output/sbatch_logs/model_training_logs/DGMR-Nimrod-%j.out    # %j will be replaced with the job ID
