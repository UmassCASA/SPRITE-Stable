...
project="UV" # Project name for outputs and logging
...
source /work/pi_mzink_umass_edu/SPRITE/skillful_nowcasting/envs/dgmr-venv-venv-uv/bin/activate
...
if [ -z "${checkpoint_path}" ]; then
    srun uv run train/run_casa_ddp_evalscore_GridCellLoss.py \
        --precision ${precision} \
        --gen_steps ${gen_steps} \
