...
precip_weight_cap=24.0   # Precipitation weight cap (e.g., 1.0, 24.0, 64.0, 128.0, 203.2)
precip_weight_cap_int=${precip_weight_cap%.*} # Truncate to an integer
...
additional_configs="PW${precip_weight_cap_int}_E${epochs}_GLR${gen_lr}_DLR${disc_lr}"
