...
#SBATCH -o /work/pi_mzink_umass_edu/SPRITE/skillful_nowcasting/output/sbatch_logs/model_training_logs/DGMR-Nimrod-32_2_16-%j.out    # %j will be replaced with the job ID
...
export PYTHONPATH=/work/pi_mzink_umass_edu/SPRITE/skillful_nowcasting
